...
1. **Name the reader, task, and source of truth.** For documentation, read `references/agent-style-quality.md` before drafting.
2. **Select the mode** (pragmatic or strict, below).
...
5. **Apply the rules** from the catalog below.
